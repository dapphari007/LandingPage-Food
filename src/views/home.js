        ...
        <div className="heroContainer home-hero1">
          <div className="home-container01">
            ...
            <span className="home-hero-sub-heading bodyLarge">
              <span>
                <span>
                  <span>Discover the power of our brand</span>
                  <span>
                    <span
          ...
          <div className="home-features1">
            ...
            <div className="home-container03">
              <FeatureCard
                ...
                SubHeading="Seamlessly integrate our platform into your existing systems"
              ></FeatureCard>
              <FeatureCard
                Heading="Real-time Analytics"
                SubHeading="Get instant access to detailed analytics and insights"
              ></FeatureCard>
              <FeatureCard
                Heading="Secure Data Storage"
                SubHeading="Rest assured knowing your data is stored securely"
              ></FeatureCard>
              <FeatureCard
                Heading="Scalable Infrastructure"
                SubHeading="Our platform can handle high volumes of data and traffic"
              ></FeatureCard>
            </div>
          </div>
        </div>
            ...
            <span>
              <span>
                <span>
                  ...
                  Nullam auctor, nunc vitae efficitur posuere, metus urna
                  ultrices odio, nec finibus justo magna id sem. Sed euismod,
                  mauris a tincidunt lobortis, velit tellus tristique dui, et
                  consequat nisl ante ut sem. Aliquam erat volutpat. Nulla
                  facilisi. Sed id mi vel nunc ultricies varius. Sed at nunc non
                  mi aliquam consectetur. Vestibulum ante ipsum primis in
                  faucibus orci luctus et ultrices posuere cubilia curae; Proin
                  nec est nec sapien feugiat tempor. Donec euismod, neque vitae
                  tincidunt lacinia, ligula erat vestibulum mi, ac aliquet enim
                  lacus sed libero.
                </span>
                <span>
                  <span
        ...
        <div className="faqContainer">
          <div className="home-faq1">
            ...
            <div className="home-container30">
              <Question1
                Answer="The purpose of this landing page is to provide information about our product/service and encourage visitors to take a specific action, such as making a purchase or signing up for a newsletter."
                Question="What is the purpose of this landing page?"
              ></Question1>
              <Question1
                Answer="You can contact our customer support team by emailing support@example.com or by calling our toll-free number at 1-800-123-4567."
                Question="How can I contact customer support?"
              ></Question1>
              <Question1
                Answer="We accept all major credit cards, including Visa, Mastercard, and American Express. We also offer the option to pay through PayPal."
                Question="What payment methods do you accept?"
              ></Question1>
              <Question1
                Answer="Yes, we have a 30-day refund policy. If you are not satisfied with your purchase, you can request a refund within 30 days of the purchase date."
